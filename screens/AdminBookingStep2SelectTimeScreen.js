...
const AdminBookingStep2SelectTimeScreen = ({ navigation, route }) => {
  ...
  const loadAvailableSlots = async () => {
    try {
      setLoading(true);
      const response = await ApiService.getAdminBookingAvailableSlots(
        selectedDate,
        service._id
      );
  ...
  const handleNext = () => {
    ...
    navigation.navigate('AdminBookingStep3EnterDetails', {
      service,
      selectedDate,
      selectedSlot,
    });
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Admin Booking - Select Time</Text>
          <View style={{ width: 24 }} />
        </View>
...
export default AdminBookingStep2SelectTimeScreen;